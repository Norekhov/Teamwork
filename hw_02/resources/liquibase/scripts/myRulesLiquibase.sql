...
insert into rules(query_name, arguments, negate)
values ('USER_OF', ('CREDIT'), true),
       ('ACTIVE_USER_OF', ('DEBIT'), false),
       ('TRANSACTION_SUM_COMPARE', ('DEBIT', 'DEPOSIT', '>', '10000'), false),
       ('TRANSACTION_SUM_COMPARE_DEPOSIT_WITHDRAW', ('DEBIT', '>'), false)
